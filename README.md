...
## How to install 
[Click Here To Download Application 64 BIT (V.2.5.0)](https://github.com/cao2501/lol-prifile-status/releases/download/V.2.5.0/League.Profile.Tool.zip)

then extract all the files somewhere and run League Profile Tool.exe

*To see old builds/change: [Releases](https://github.com/cao2501/lol-prifile-status/releases)*
